...
import {
  ...
  ChevronRight, GraduationCap, Trophy, Clock, Eye, Phone,
...
export default function ProfileView() {
  ...
  const toggleLike = (id: number) =>
    setFeedLikes(prev => { const n = new Set(prev); n.has(id) ? n.delete(id) : n.add(id); return n; });
            ...
            <section>
              ...
              {[
                ...
                <div key={post.id} style={{ ...CARD, marginBottom: '10px', overflow: 'hidden' }}>
                  <img src={post.img} alt={post.title} className="w-full object-cover" style={{ height: '160px' }} />
                  <div className="p-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 rounded-xl" style={{ backgroundColor: '#f8f8fa' }}>
                    <div className="flex-shrink-0 flex flex-col items-center justify-center rounded-xl" style={{ width: '44px', height: '44px', backgroundColor: '#0066cc14' }}>
                      <span style={{ fontSize: '15px', fontWeight: 700, color: '#0066cc', lineHeight: 1 }}>{exam.date.split(' ')[1]}</span>
                      <span style={{ fontSize: '9px', color: '#6e6e73' }}>{exam.month}</span>
                    </div>
