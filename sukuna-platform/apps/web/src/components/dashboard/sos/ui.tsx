...
export function ConfirmationModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-end min-[640px]:items-center justify-center fade-in pb-[100px] px-4 min-[640px]:p-0"
      style={{ background: 'rgba(0,0,0,0.3)' }}
    >
      <div
        className="w-full bg-canvas border border-hairline slide-up max-h-[calc(100vh-120px)] overflow-y-auto min-[640px]:max-h-none"
