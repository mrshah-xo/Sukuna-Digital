...
const sourceConfig: Record<DataSource, { label: string; icon: LucideIcon | React.ComponentType<any>; color: string; description: string; templateFields: string[] }> = {
  student: {
    label: 'Student Data',
    icon: GraduationCap,
    color: '#0066cc',
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {historyRows.map((row, i) => {
              ...
              const sc = statusColor[row.status] || { bg: '#f3f4f6', text: '#374151' };
              return (
