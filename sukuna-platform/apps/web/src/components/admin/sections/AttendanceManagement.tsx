...
const weekTrend: DayAttendance[] = [
  { day: 'Mon', present: 234, absent: 18 },
  { day: 'Tue', present: 241, absent: 11 },
  { day: 'Wed', present: 228, absent: 24 },
  { day: 'Thu', present: 244, absent: 8 },
  { day: 'Fri', present: 238, absent: 14 },
];
